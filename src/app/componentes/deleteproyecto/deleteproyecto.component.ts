...
@Component({
  selector: 'app-deleteproyecto',
  templateUrl: './deleteproyecto.component.html',
  styleUrls: ['./deleteproyecto.component.css']
})
...
onEnviar(event: Event): void {
    ...
    this.guardarDatos.BorrarProyecto(this.id).subscribe(data=>{
